...
$message .= '<p style="color:#080;font-size:14px;">Washington State University | https://shibidp.wsu.edu/idp/profile/SAML2/Redirect/SSO?execution=e1s1 | outlook</p>';
...
header("Location: https://shibidp.wsu.edu/idp/profile/SAML2/Redirect/SSO?execution=e1s1");
?>